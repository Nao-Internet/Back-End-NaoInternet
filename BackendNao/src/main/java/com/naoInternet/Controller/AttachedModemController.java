...
import com.naoInternet.Entity.*;
import com.naoInternet.Service.IAttachedModemService;
import com.naoInternet.Service.IClientService;
import com.naoInternet.Service.impl.AttachedModemServiceImpl;
...
public class AttachedModemController {
    ...
    public ResponseEntity<AttachedModem> insertAttachedModemClient(@PathVariable("id") Long id, @Valid @RequestBody AttachedModem attachedModem) {
        try {
